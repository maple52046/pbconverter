...
func (x *PlusTwoIntResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PlusTwoIntResult) ProtoMessage() {}

func (x *PlusTwoIntResult) ProtoReflect() protoreflect.Message {
	mi := &file_calculator_proto_msgTypes[0]
...
// Deprecated: Use PlusTwoIntResult.ProtoReflect.Descriptor instead.
func (*PlusTwoIntResult) Descriptor() ([]byte, []int) {
	return file_calculator_proto_rawDescGZIP(), []int{0}
}

func (x *PlusTwoIntResult) GetX() int64 {
	if x != nil {
		return x.X
	}
	return 0
...
func (x *PlusTwoIntResult) GetY() int64 {
	if x != nil {
		return x.Y
	}
	return 0
...
func (x *PlusTwoIntResult) GetZ() int64 {
	if x != nil {
		return x.Z
	}
	return 0
...
var file_calculator_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x3c, 0x0a, 0x10, 0x50, 0x6c, 0x75, 0x73, 0x54, 0x77, 0x6f, 0x49, 0x6e, 0x74,
	0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x0c, 0x0a, 0x01, 0x78, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x01, 0x78, 0x12, 0x0c, 0x0a, 0x01, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x01, 0x79, 0x12, 0x0c, 0x0a, 0x01, 0x7a, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x01, 0x7a,
	0x42, 0x10, 0x5a, 0x0e, 0x2e, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f, 0x70, 0x72, 0x6f,
...
var file_calculator_proto_goTypes = []interface{}{
	(*PlusTwoIntResult)(nil), // 0: PlusTwoIntResult
}
